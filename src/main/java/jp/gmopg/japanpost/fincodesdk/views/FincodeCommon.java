...
abstract class FincodeCommon extends LinearLayout {
    ...
    public void initForPayment(FincodeConfiguration config, Options options, FincodeCallback<FincodePaymentResponse> callback) {
    ...
    public void initForCardRegister(FincodeConfiguration config, Options options, FincodeCallback<FincodeCardRegisterResponse> callback) {
        DataHolder.getInstance().setCallbackForCardRegister(callback);
        DataHolder.getInstance().setConfig(config);
        DataHolder.getInstance().setOptions(options);
    }

    public void initForCardUpdate(FincodeConfiguration config, Options options, FincodeCallback<FincodeCardUpdateResponse> callback) {
